...
class Snake:
    ...
    # a new function add_tail from me :)
    def add_tail(self):

        # add tail if the snake got the food
        pos_x = STARTING_POSITIONS[-1][0]
        pos_y = STARTING_POSITIONS[-1][1]
        ...
        # change the position for the next event of the snake got the fruit
        pos_x -= 20
        pos_y = 0

        # add the new position into STARTING_POSITIONS
